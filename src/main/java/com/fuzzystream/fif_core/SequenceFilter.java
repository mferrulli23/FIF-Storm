...
public class SequenceFilter extends Filter {
	...
	/**
	 * This method allows to set a list of filters composing the sequence
	 * filter.<br>
	 * <br>
	 * 
	 * Every time you call this method, the previous internal filters are
	 * destroyed and replaced by the new filters.<br>
	 * You can set a variable numbers of filters.<br>
	 * The order is extremely important. The same order you set the parameters,
	 * the same it will be set into the sequence. <br>
	 * So, first parameter is first element of the sequence, second parameter
	 * second element etc...<br>
	 * <br>
	 * 
	 * Preconditions: <br>
	 * <br>
	 * 1-None of the filters must be null.<br>
	 * <br>
	 * 
	 * Postconditions:<br>
	 * <br>
	 * 1-The filters are set correctly.<br>
	 * <br>
	 * 
	 * @param list
	 *            The list of filters you want to set in this filter.
	 */
