...
public class ResourceRegister {
	...
	private static ArrayList<Resource> resourceKey = new ArrayList<Resource>();
	...
	public void removeAssociation(Resource r) {
		...
		this.resourceKey.remove(r);


	}
	
	public ArrayList<Resource> getSequence(){
